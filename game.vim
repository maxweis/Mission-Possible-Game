" ~/.vim/sessions/game.vim:
" Vim session script.
" Created by session.vim 2.10.1 on 04 August 2015 at 16:11:48.
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 35 + 38) / 76)
exe '2resize ' . ((&lines * 37 + 38) / 76)
exe 'vert 2resize ' . ((&columns * 108 + 109) / 218)
exe '3resize ' . ((&lines * 37 + 38) / 76)
exe 'vert 3resize ' . ((&columns * 109 + 109) / 218)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 108 + 109) / 218)
